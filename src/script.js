...
const walls = new THREE.Mesh(
  new THREE.BoxBufferGeometry(wallsWidth, wallsHeight, 4),
...
const door = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({
    ...
    aoMap: doorAmbientOcclusionTexture, // needs uv coord, controls shadows in edges and crevices
    displacementMap: doorHeightTexture, // moves vertices
    displacementScale: 0.1,
    normalMap: doorNormalTexture, // Add light details
